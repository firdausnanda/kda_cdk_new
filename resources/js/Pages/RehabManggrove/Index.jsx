...
export default function Index({ auth, datas, stats, filters, availableYears, sumberDana }) {
  ...
  const handleBulkAction = (action) => {
    ...
    switch (action) {
      case 'delete':
        ...
        routeName = 'rehab-manggrove.bulk-delete';
        color = '#d33';
        break;
      case 'submit':
        title = 'Ajukan Data Terpilih?';
        confirmText = 'Ya, Ajukan!';
        routeName = 'rehab-manggrove.bulk-submit';
        color = '#15803d';
        break;
      case 'approve':
        title = 'Setujui Data Terpilih?';
        confirmText = 'Ya, Setujui!';
        routeName = 'rehab-manggrove.bulk-approve';
        color = '#15803d';
        break;
      default:
        return;
  ...
  const handleYearChange = (year) => {
    ...
    setIsLoading(true);
    router.get(route('rehab-manggrove.index'), {
      year,
      search: searchTerm,
      sort: filters.sort,
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              {canCreate && (
                <div className="flex gap-2">
                  <button onClick={() => window.location.href = route('rehab-manggrove.export', { year: filters.year })} className="flex items-center gap-2 px-4 py-2.5 bg-primary-700 text-primary-100 rounded-xl font-bold text-sm shadow-sm hover:bg-primary-800 transition-colors border border-primary-600/50">
