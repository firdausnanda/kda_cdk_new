...
export default function SumberDanaIndex({ auth, sumberDana, filters }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (modalMode === 'create') {
      post(route('sumber-dana.store'), {
        onSuccess: () => closeModal(),
      });
    } else {
      put(route('sumber-dana.update', currentData.id), {
        onSuccess: () => closeModal(),
      });
    }
  };
  ...
  const handleDelete = () => {
    destroy(route('sumber-dana.destroy', currentData.id), {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Master Data Sumber Dana</h2>}
    >
      <Head title="Master Data Sumber Dana" />
          ...
          <div className="bg-white overflow-hidden shadow-xl sm:rounded-2xl ring-1 ring-gray-900/5">
            ...
            <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center bg-gray-50/50">
              <h3 className="text-lg font-bold text-gray-900 mb-4 sm:mb-0">
                Daftar Sumber Dana
                <p className="text-sm font-normal text-gray-500 mt-1">Kelola data sumber dana dalam sistem.</p>
              </h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {sumberDana.data.length > 0 ? (
                    sumberDana.data.map((item) => (
                    ...
                    <tr>
                      <td colSpan="3" className="px-6 py-12 text-center text-sm text-gray-500">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-gray-500 text-lg font-medium">Tidak ada data Sumber Dana</p>
            ...
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 rounded-b-2xl">
              <Pagination links={sumberDana.links} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">
              {modalMode === 'create' ? 'Tambah Sumber Dana' : 'Edit Sumber Dana'}
            </h2>
