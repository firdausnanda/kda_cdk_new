...
export default function ProvincesIndex({ auth, provinces, filters }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (modalMode === 'create') {
            ...
            put(route('provinces.update', currentProvince.id), {
                onSuccess: () => closeModal(),
            });
        }
    };
    ...
    const handleDelete = () => {
        destroy(route('provinces.destroy', currentProvince.id), {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Master Data Provinsi</h2>}
        >
            <Head title="Master Data Provinsi" />
                    ...
                    <div className="bg-white overflow-hidden shadow-xl sm:rounded-2xl ring-1 ring-gray-900/5">
                        ...
                        <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center bg-gray-50/50">
                            <h3 className="text-lg font-bold text-gray-900 mb-4 sm:mb-0">
                                Daftar Provinsi
                                <p className="text-sm font-normal text-gray-500 mt-1">Kelola data provinsi dalam sistem.</p>
                            </h3>
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {provinces.data.length > 0 ? (
                                        provinces.data.map((province, index) => (
                                            <tr key={province.id} className="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <tr>
                                            <td colSpan="3" className="px-6 py-12 text-center text-sm text-gray-500">
                                                <div className="flex flex-col items-center justify-center">
                                                    ...
                                                    <p className="text-gray-500 text-lg font-medium">Tidak ada data provinsi</p>
                ...
                <div className="p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-bold text-gray-900">
                            {modalMode === 'create' ? 'Tambah Provinsi Baru' : 'Edit Data Provinsi'}
                        </h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <InputLabel htmlFor="id" value="ID Provinsi (Kode Wilayah)" />
                            <TextInput
                                id="id"
                                type="text"
            ...
            <Modal show={isDeleteModalOpen} onClose={closeDeleteModal}>
                <div className="p-6 text-center">
                    ...
                    <p className="text-gray-500 mb-6">
                        Apakah Anda yakin ingin menghapus data provinsi <span className="font-semibold text-gray-800">"{currentProvince?.name}"</span>? Tindakan ini tidak dapat dibatalkan.
                    </p>
