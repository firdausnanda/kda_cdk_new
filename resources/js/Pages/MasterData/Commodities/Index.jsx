...
export default function CommodityIndex({ auth, commodities, filters }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (modalMode === 'create') {
      ...
      put(route('commodities.update', currentData.id), {
        onSuccess: () => closeModal(),
      });
    }
  };
  ...
  const handleDelete = () => {
    destroy(route('commodities.destroy', currentData.id), {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Master Data Komoditas</h2>}
    >
          ...
          <div className="bg-white overflow-hidden shadow-xl sm:rounded-2xl ring-1 ring-gray-900/5">
            ...
            <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center bg-gray-50/50">
              <h3 className="text-lg font-bold text-gray-900 mb-4 sm:mb-0">
                Daftar Komoditas
                <p className="text-sm font-normal text-gray-500 mt-1">Kelola data komoditas dalam sistem.</p>
              </h3>
                    ...
                    <tr>
                      <td colSpan="4" className="px-6 py-12 text-center text-sm text-gray-500">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-gray-500 text-lg font-medium">Tidak ada data Komoditas</p>
            ...
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 rounded-b-2xl">
              <Pagination links={commodities.links} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">
              {modalMode === 'create' ? 'Tambah Komoditas' : 'Edit Komoditas'}
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <InputLabel htmlFor="name" value="Nama Komoditas" />
              <TextInput
                id="name"
                type="text"
            ...
            <div>
              <InputLabel htmlFor="type" value="Tipe (Opsional)" />
              <TextInput
                id="type"
                type="text"
                className="mt-1 block w-full"
                ...
                placeholder="Contoh: Hasil Hutan Bukan Kayu"
              />
