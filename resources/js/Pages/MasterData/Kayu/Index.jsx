...
export default function KayuIndex({ auth, kayu, filters }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (modalMode === 'create') {
      post(route('kayu.store'), {
        onSuccess: () => closeModal(),
      });
    } else {
      put(route('kayu.update', currentData.id), {
        onSuccess: () => closeModal(),
      });
    }
  };
  ...
  const handleDelete = () => {
    destroy(route('kayu.destroy', currentData.id), {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Master Data Kayu</h2>}
    >
      <Head title="Master Data Kayu" />
          ...
          <div className="bg-white overflow-hidden shadow-xl sm:rounded-2xl ring-1 ring-gray-900/5">
            ...
            <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center bg-gray-50/50">
              <h3 className="text-lg font-bold text-gray-900 mb-4 sm:mb-0">
                Daftar Kayu
                <p className="text-sm font-normal text-gray-500 mt-1">Kelola data jenis kayu dalam sistem.</p>
              </h3>
                    ...
                    <tr>
                      <td colSpan="3" className="px-6 py-12 text-center text-sm text-gray-500">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-gray-500 text-lg font-medium">Tidak ada data Kayu</p>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">
              {modalMode === 'create' ? 'Tambah Kayu' : 'Edit Kayu'}
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <InputLabel htmlFor="name" value="Nama Kayu" />
              <TextInput
                id="name"
                type="text"
