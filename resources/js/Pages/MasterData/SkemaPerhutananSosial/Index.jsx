...
export default function SkemaPerhutananSosialIndex({ auth, skema, filters }) {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      router.get(
        route('skema-perhutanan-sosial.index'),
        { search },
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (modalMode === 'create') {
      post(route('skema-perhutanan-sosial.store'), {
        onSuccess: () => closeModal(),
      });
    } else {
      put(route('skema-perhutanan-sosial.update', currentData.id), {
        onSuccess: () => closeModal(),
      });
    }
  };
  ...
  const handleDelete = () => {
    destroy(route('skema-perhutanan-sosial.destroy', currentData.id), {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Master Data Skema Perhutanan Sosial</h2>}
    >
      <Head title="Master Data Skema Perhutanan Sosial" />
          ...
          <div className="bg-white overflow-hidden shadow-xl sm:rounded-2xl ring-1 ring-gray-900/5">
            ...
            <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center bg-gray-50/50">
              <h3 className="text-lg font-bold text-gray-900 mb-4 sm:mb-0">
                Daftar Skema Perhutanan Sosial
                <p className="text-sm font-normal text-gray-500 mt-1">Kelola data skema perhutanan sosial dalam sistem.</p>
              </h3>
                    ...
                    <tr>
                      <td colSpan="3" className="px-6 py-12 text-center text-sm text-gray-500">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-gray-500 text-lg font-medium">Tidak ada data Skema Perhutanan Sosial</p>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">
              {modalMode === 'create' ? 'Tambah Skema Perf. Sosial' : 'Edit Skema Perf. Sosial'}
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <InputLabel htmlFor="name" value="Nama Skema" />
              <TextInput
                id="name"
                type="text"
