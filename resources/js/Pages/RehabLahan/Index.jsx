...
export default function Index({ auth, datas, stats, filters, availableYears, sumberDana }) {
    ...
    const handleBulkAction = (action) => {
        ...
        switch (action) {
            case 'delete':
                ...
                routeName = 'rehab-lahan.bulk-delete'; // We defined this as POST
                color = '#d33';
                break;
            case 'submit':
    ...
    const handleYearChange = (year) => {
        ...
        setIsLoading(true);
        router.get(route('rehab-lahan.index'), {
            year,
            search: searchTerm,
            sort: filters.sort,
    ...
    const handleDelete = (id) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setIsLoading(true);
                router.delete(route('rehab-lahan.destroy', id), {
                    preserveScroll: true,
                    onSuccess: () => {
                        setIsLoading(false);
                        MySwal.fire({
    ...
    const handleSubmit = (id) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setIsLoading(true);
                router.post(route('rehab-lahan.submit', id), {}, {
                    preserveScroll: true,
                    onFinish: () => setIsLoading(false)
                });
            }
    ...
    const handleVerify = (id) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setIsLoading(true);
                router.post(route('rehab-lahan.approve', id), {}, {
                    preserveScroll: true,
                    onFinish: () => setIsLoading(false)
                });
            }
    ...
    const handleReject = (id) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setIsLoading(true);
                router.post(route('rehab-lahan.reject', id), {
                ...
                <div className={`space-y-6 transition-all duration-700 ease-in-out ${isLoading ? 'opacity-30 blur-md grayscale-[0.5] pointer-events-none' : 'opacity-100 blur-0'}`}>
                    ...
                    <div className="bg-gradient-to-r from-primary-800 to-primary-600 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                <h3 className="text-2xl font-bold font-display">Data Rehabilitasi Hutan dan Lahan</h3>
                    ...
                    <div className="p-6 space-y-8">
                        <div className="flex gap-4 items-start">
                            ...
                            <div className="flex-1">
                                ...
                                <button type="button" onClick={() => window.location.href = route('rehab-lahan.template')} className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 text-xs font-bold rounded-lg border border-blue-100 hover:bg-blue-100 transition-colors">
