...
export default function Create({ auth, provinces, regencies }) {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Tambah Data Realisasi PNBP</h2>}
    >
      <Head title="Tambah Data - Realisasi PNBP" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Lengkapi informasi realisasi PNBP di bawah ini.
            </p>
          </div>
