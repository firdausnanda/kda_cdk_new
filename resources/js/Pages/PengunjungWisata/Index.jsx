...
export default function Index({ auth, datas, stats, filters, availableYears }) {
  ...
  const handleBulkAction = (action) => {
    ...
    let title = '';
    const routeName = 'pengunjung-wisata.bulk-workflow-action';
    let confirmText = '';
    let color = '#3085d6';
    let showInput = false;
          ...
          <div className="bg-gradient-to-r from-primary-800 to-primary-600 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => window.location.href = route('pengunjung-wisata.export', { year: filters.year })}
      ...
      <Modal show={showImportModal} onClose={() => setShowImportModal(false)}>
        <form onSubmit={handleImportSubmit} className="p-0 overflow-hidden">
          <div className="p-6 bg-slate-50 border-b border-gray-100 flex items-center justify-between">
            <h2 className="text-lg font-bold text-gray-900">Import Data Pengunjung Wisata</h2>
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="flex-1">
                ...
                <button type="button" onClick={() => window.location.href = route('pengunjung-wisata.template')} className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 text-xs font-bold rounded-lg border border-blue-100 hover:bg-blue-100 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                  </svg>
              ...
              <div className="flex-1">
                ...
                <div className={`relative border-2 border-dashed rounded-xl p-6 transition-all duration-200 text-center cursor-pointer ${importFile ? 'border-primary-500 bg-primary-50/50' : 'border-gray-200 hover:border-primary-300 hover:bg-gray-50'}`}>
                  ...
                  <div className="space-y-2 pointer-events-none">
                    ...
                    {importFile ? (
                      <div>
                        <p className="text-sm font-bold text-primary-800">{importFile.name}</p>
                        <p className="text-xs text-primary-600 mt-1">{(importFile.size / 1024).toFixed(1)} KB</p>
                      </div>
                    ) : (
