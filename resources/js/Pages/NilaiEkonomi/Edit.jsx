...
export default function Edit({ auth, nilaiEkonomi, commodities }) {
  const { data, setData, put, processing, errors } = useForm({
    ...
    month: nilaiEkonomi.month || new Date().getMonth() + 1,
    province_id: nilaiEkonomi.province_id || 35,
    regency_id: nilaiEkonomi.regency_id || '',
    district_id: nilaiEkonomi.district_id || '',
  ...
  const submit = (e) => {
    e.preventDefault();
    put(route('nilai-ekonomi.update', nilaiEkonomi.id));
  };
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Data Nilai Ekonomi</h2>}
    >
      <Head title="Edit Nilai Ekonomi" />
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
            <div className="p-8 border-b border-gray-100 bg-gray-50/50">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Perbarui informasi kelompok dan lokasi kegiatan perhutanan sosial.
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-8 border-b border-gray-100 bg-gray-50/50 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Perbarui rincian komoditas hasil hutan.
                </p>
              </div>
