...
export default function Create({ auth, kayu_list, forest_type }) {
  ...
  return (
    ...
    >
      <Head title={`Input Produksi dari ${forest_type} - Hasil Hutan Bukan Kayu`} />

      <div className="max-w-4xl mx-auto">
        <Link
          href={route('hasil-hutan-bukan-kayu.index', { forest_type })}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Lengkapi informasi di bawah ini untuk menambahkan data hasil hutan bukan kayu ({forest_type}).
            </p>
          </div>
