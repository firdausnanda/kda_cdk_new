...
class RehabLahanExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithTitle
{
  protected $year;
  ...
  {
    return 'Rehabilitasi Lahan ' . ($this->year ?? 'Semua Tahun');
  }
}
