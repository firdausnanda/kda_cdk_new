...
class PenghijauanLingkunganTemplateExport implements WithHeadings, ShouldAutoSize, WithTitle, WithStyles, WithEvents
{
  ...
  public function registerEvents(): array
  {
    return [
      AfterSheet::class => function (AfterSheet $event) {
        ...
        $sheet->getComment('C1')->getText()->createTextRun('Isi dengan Nama Kabupaten/Kota');
        $sheet->getComment('D1')->getText()->createTextRun('Isi dengan Nama Kecamatan');
        $sheet->getComment('E1')->getText()->createTextRun('Isi dengan Nama Desa');
